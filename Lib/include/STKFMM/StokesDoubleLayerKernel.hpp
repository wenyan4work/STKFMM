    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                p = add_intrin(p, mul_intrin(add_intrin(commonCoeff,
                                                        mul_intrin(r2, trace)),
                                             rinv5));
                vx = add_intrin(vx,
            ...
            p = add_intrin(mul_intrin(p, facp),
...
#define SRC_BLK 500
    ...
    const Real_t FACV5 = 1 / (8 * const_pi<Real_t>() * nwtn_scal * nwtn_scal *
                              nwtn_scal * nwtn_scal * nwtn_scal);
    const Vec_t facv5 =
        set_intrin<Vec_t, Real_t>(FACV5); // vi = 1/8pi (-3rirjrk/r^5) Djk
    const Vec_t facp5 = set_intrin<Vec_t, Real_t>(
        FACV5 * 2); // p = 1/4pi (-4 rjrk/r^5 + delta_jk) Djk

    const Real_t FACV7 =
        3 / (8 * const_pi<Real_t>() * nwtn_scal * nwtn_scal * nwtn_scal *
             nwtn_scal * nwtn_scal * nwtn_scal * nwtn_scal);
    const Vec_t facv7 = set_intrin<Vec_t, Real_t>(-FACV7); // -3/8pi
    const Vec_t facp7 =
        set_intrin<Vec_t, Real_t>(FACV7 * 2); // 3/4pi(5 ... - ...)
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                Vec_t trace = add_intrin(add_intrin(sxx, syy), szz);
                Vec_t rksxk = add_intrin(
                    mul_intrin(dx, sxx),
                    add_intrin(mul_intrin(dy, sxy), mul_intrin(dz, sxz)));
                Vec_t rksyk = add_intrin(
                    mul_intrin(dx, syx),
                    add_intrin(mul_intrin(dy, syy), mul_intrin(dz, syz)));
                Vec_t rkszk = add_intrin(
                    mul_intrin(dx, szx),
                    add_intrin(mul_intrin(dy, szy), mul_intrin(dz, szz)));

                Vec_t rkskx = add_intrin(
                    mul_intrin(dx, sxx),
                    add_intrin(mul_intrin(dy, syx), mul_intrin(dz, szx)));
                Vec_t rksky = add_intrin(
                    mul_intrin(dx, sxy),
                    add_intrin(mul_intrin(dy, syy), mul_intrin(dz, szy)));
                Vec_t rkskz = add_intrin(
                    mul_intrin(dx, sxz),
                    add_intrin(mul_intrin(dy, syz), mul_intrin(dz, szz)));

                p = add_intrin(p, mul_intrin(add_intrin(commonCoeffn3,
                                                        mul_intrin(r2, trace)),
                                             rinv5));
                vx = add_intrin(
                    vx, mul_intrin(rinv5, mul_intrin(dx, commonCoeffn3)));
                vy = add_intrin(
                    vy, mul_intrin(rinv5, mul_intrin(dy, commonCoeffn3)));
                vz = add_intrin(
                    vz, mul_intrin(rinv5, mul_intrin(dz, commonCoeffn3)));

                // pgrad
                Vec_t px = sub_intrin(
                    mul_intrin(dx, commonCoeff5),
                    mul_intrin(r2, add_intrin(add_intrin(rksxk, rkskx),
                                              mul_intrin(dx, trace))));
                Vec_t py = sub_intrin(
                    mul_intrin(dy, commonCoeff5),
                    mul_intrin(r2, add_intrin(add_intrin(rksyk, rksky),
                                              mul_intrin(dy, trace))));
                Vec_t pz = sub_intrin(
                    mul_intrin(dz, commonCoeff5),
                    mul_intrin(r2, add_intrin(add_intrin(rkszk, rkskz),
                                              mul_intrin(dz, trace))));
                ...
                dcFd0 = add_intrin(
                    dcFd0,
                    mul_intrin(none, mul_intrin(dy, add_intrin(sxy, syx))));
                dcFd0 = add_intrin(
                    dcFd0,
                    mul_intrin(none, mul_intrin(dz, add_intrin(sxz, szx))));
                ...
                dcFd1 = add_intrin(
                    dcFd1,
                    mul_intrin(none, mul_intrin(dx, add_intrin(sxy, syx))));
                dcFd1 = add_intrin(
                    dcFd1,
                    mul_intrin(none, mul_intrin(dz, add_intrin(syz, szy))));
                ...
                dcFd2 = add_intrin(
                    dcFd2,
                    mul_intrin(none, mul_intrin(dx, add_intrin(sxz, szx))));
                dcFd2 = add_intrin(
                    dcFd2,
                    mul_intrin(none, mul_intrin(dy, add_intrin(syz, szy))));
                ...
                tv0 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dx, dx)));
                tv0 = add_intrin(
                    tv0,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dx, dcFd0))));
                tv0 = add_intrin(
                    tv0, mul_intrin(none, mul_intrin(r2, commonCoeffn1)));
                tv0 = mul_intrin(tv0, rinv7);
                tv1 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dx, dy)));
                tv1 = add_intrin(
                    tv1,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dx, dcFd1))));
                tv1 = mul_intrin(tv1, rinv7);
                tv2 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dx, dz)));
                tv2 = add_intrin(
                    tv2,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dx, dcFd2))));
                tv2 = mul_intrin(tv2, rinv7);

                tv3 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dy, dx)));
                tv3 = add_intrin(
                    tv3,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dy, dcFd0))));
                tv3 = mul_intrin(tv3, rinv7);
                tv4 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dy, dy)));
                tv4 = add_intrin(
                    tv4,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dy, dcFd1))));
                tv4 = add_intrin(
                    tv4, mul_intrin(none, mul_intrin(r2, commonCoeffn1)));
                tv4 = mul_intrin(tv4, rinv7);
                tv5 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dy, dz)));
                tv5 = add_intrin(
                    tv5,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dy, dcFd2))));
                tv5 = mul_intrin(tv5, rinv7);

                tv6 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dz, dx)));
                tv6 = add_intrin(
                    tv6,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dz, dcFd0))));
                tv6 = mul_intrin(tv6, rinv7);
                tv7 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dz, dy)));
                tv7 = add_intrin(
                    tv7,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dz, dcFd1))));
                tv7 = mul_intrin(tv7, rinv7);
                tv8 = mul_intrin(five,
                                 mul_intrin(commonCoeffn1, mul_intrin(dz, dz)));
                tv8 = add_intrin(
                    tv8,
                    mul_intrin(none, mul_intrin(r2, mul_intrin(dz, dcFd2))));
                tv8 = add_intrin(
                    tv8, mul_intrin(none, mul_intrin(r2, commonCoeffn1)));
            ...
            p = add_intrin(mul_intrin(p, facp5),
                           load_intrin<Vec_t>(&trg_value[0][t]));
            vx = add_intrin(mul_intrin(vx, facv5),
                            load_intrin<Vec_t>(&trg_value[1][t]));
            vy = add_intrin(mul_intrin(vy, facv5),
                            load_intrin<Vec_t>(&trg_value[2][t]));
            vz = add_intrin(mul_intrin(vz, facv5),
                            load_intrin<Vec_t>(&trg_value[3][t]));

            pxSum = add_intrin(mul_intrin(pxSum, facp7),
                               load_intrin<Vec_t>(&trg_value[4][t]));
            pySum = add_intrin(mul_intrin(pySum, facp7),
                               load_intrin<Vec_t>(&trg_value[5][t]));
            pzSum = add_intrin(mul_intrin(pzSum, facp7),
                               load_intrin<Vec_t>(&trg_value[6][t]));

            vxxSum = add_intrin(mul_intrin(vxxSum, facv7),
                                load_intrin<Vec_t>(&trg_value[7][t]));
            vxySum = add_intrin(mul_intrin(vxySum, facv7),
                                load_intrin<Vec_t>(&trg_value[8][t]));
            vxzSum = add_intrin(mul_intrin(vxzSum, facv7),
                                load_intrin<Vec_t>(&trg_value[9][t]));

            vyxSum = add_intrin(mul_intrin(vyxSum, facv7),
                                load_intrin<Vec_t>(&trg_value[10][t]));
            vyySum = add_intrin(mul_intrin(vyySum, facv7),
                                load_intrin<Vec_t>(&trg_value[11][t]));
            vyzSum = add_intrin(mul_intrin(vyzSum, facv7),
                                load_intrin<Vec_t>(&trg_value[12][t]));

            vzxSum = add_intrin(mul_intrin(vzxSum, facv7),
                                load_intrin<Vec_t>(&trg_value[13][t]));
            vzySum = add_intrin(mul_intrin(vzySum, facv7),
                                load_intrin<Vec_t>(&trg_value[14][t]));
            vzzSum = add_intrin(mul_intrin(vzzSum, facv7),
                                load_intrin<Vec_t>(&trg_value[15][t]));
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                np = mul_intrin(
                    mul_intrin(mul_intrin(add_intrin(commonCoeffn3,
                                                     mul_intrin(r2, trace)),
                                          rinv7),
                               r2),
                    facp);
                ...
                txxSum =
                    add_intrin(txxSum, add_intrin(np, add_intrin(tv0, tv0)));
                ...
                tyySum =
                    add_intrin(tyySum, add_intrin(np, add_intrin(tv4, tv4)));
                ...
                tzzSum =
                    add_intrin(tzzSum, add_intrin(np, add_intrin(tv8, tv8)));
            }

            txxSum = add_intrin(mul_intrin(txxSum, facv7),
                                load_intrin<Vec_t>(&trg_value[0][t]));
            txySum = add_intrin(mul_intrin(txySum, facv7),
                                load_intrin<Vec_t>(&trg_value[1][t]));
            txzSum = add_intrin(mul_intrin(txzSum, facv7),
                                load_intrin<Vec_t>(&trg_value[2][t]));

            tyxSum = add_intrin(mul_intrin(tyxSum, facv7),
                                load_intrin<Vec_t>(&trg_value[3][t]));
            tyySum = add_intrin(mul_intrin(tyySum, facv7),
                                load_intrin<Vec_t>(&trg_value[4][t]));
            tyzSum = add_intrin(mul_intrin(tyzSum, facv7),
                                load_intrin<Vec_t>(&trg_value[5][t]));

            tzxSum = add_intrin(mul_intrin(tzxSum, facv7),
                                load_intrin<Vec_t>(&trg_value[6][t]));
            tzySum = add_intrin(mul_intrin(tzySum, facv7),
                                load_intrin<Vec_t>(&trg_value[7][t]));
            tzzSum = add_intrin(mul_intrin(tzzSum, facv7),
                                load_intrin<Vec_t>(&trg_value[8][t]));
...
#define SRC_BLK 500
    ...
    Vec_t inv_nwtn_scal5 = set_intrin<Vec_t, Real_t>(
        1.0 / (nwtn_scal * nwtn_scal * nwtn_scal * nwtn_scal * nwtn_scal));
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                Vec_t rinv5 =
                    mul_intrin(mul_intrin(rinv, rinv4), inv_nwtn_scal5);

                Vec_t commonCoeff = mul_intrin(sv0, mul_intrin(dx, dx));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv1, mul_intrin(dx, dy)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv2, mul_intrin(dx, dz)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv3, mul_intrin(dy, dx)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv4, mul_intrin(dy, dy)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv5, mul_intrin(dy, dz)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv6, mul_intrin(dz, dx)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv7, mul_intrin(dz, dy)));
                commonCoeff = add_intrin(commonCoeff,
                                         mul_intrin(sv8, mul_intrin(dz, dz)));

                tvx = add_intrin(
                    tvx, mul_intrin(rinv5, mul_intrin(dx, commonCoeff)));
                tvy = add_intrin(
                    tvy, mul_intrin(rinv5, mul_intrin(dy, commonCoeff)));
                tvz = add_intrin(
                    tvz, mul_intrin(rinv5, mul_intrin(dz, commonCoeff)));
            }
            Vec_t ooep = set_intrin<Vec_t, Real_t>(OOEP);

            tvx = add_intrin(mul_intrin(tvx, ooep),
                             load_intrin<Vec_t>(&trg_value[0][t]));
            tvy = add_intrin(mul_intrin(tvy, ooep),
                             load_intrin<Vec_t>(&trg_value[1][t]));
            tvz = add_intrin(mul_intrin(tvz, ooep),
                             load_intrin<Vec_t>(&trg_value[2][t]));
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                pressure =
                    add_intrin(pressure, mul_intrin(sv1, mul_intrin(dx, dy)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv2, mul_intrin(dx, dz)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv3, mul_intrin(dy, dx)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv4, mul_intrin(dy, dy)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv5, mul_intrin(dy, dz)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv6, mul_intrin(dz, dx)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv7, mul_intrin(dz, dy)));
                pressure =
                    add_intrin(pressure, mul_intrin(sv8, mul_intrin(dz, dz)));
            ...
            tv = add_intrin(mul_intrin(tv, ooep),
                            load_intrin<Vec_t>(&trg_value[0][t]));
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                Vec_t rinv5 = mul_intrin(rinv, rinv4);
                Vec_t rinv7 =
                    mul_intrin(mul_intrin(rinv2, rinv5), inv_nwtn_scal7);
                ...
                dcFd0 = add_intrin(
                    dcFd0,
                    mul_intrin(negone, mul_intrin(dy, add_intrin(sv1, sv3))));
                dcFd0 = add_intrin(
                    dcFd0,
                    mul_intrin(negone, mul_intrin(dz, add_intrin(sv2, sv6))));
                ...
                dcFd1 = add_intrin(
                    dcFd1,
                    mul_intrin(negone, mul_intrin(dx, add_intrin(sv1, sv3))));
                dcFd1 = add_intrin(
                    dcFd1,
                    mul_intrin(negone, mul_intrin(dz, add_intrin(sv5, sv7))));
                ...
                dcFd2 = add_intrin(
                    dcFd2,
                    mul_intrin(negone, mul_intrin(dx, add_intrin(sv2, sv6))));
                dcFd2 = add_intrin(
                    dcFd2,
                    mul_intrin(negone, mul_intrin(dy, add_intrin(sv5, sv7))));
                ...
                tv0 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dx, dx)));
                tv0 = mul_intrin(tv0, rinv7);
                tv0 = add_intrin(
                    tv0, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dx, dcFd0))));
                tv0 = add_intrin(
                    tv0, mul_intrin(negone, mul_intrin(rinv5, commonCoeff)));
                tv1 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dx, dy)));
                tv1 = mul_intrin(tv1, rinv7);
                tv1 = add_intrin(
                    tv1, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dx, dcFd1))));
                tv2 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dx, dz)));
                tv2 = mul_intrin(tv2, rinv7);
                tv2 = add_intrin(
                    tv2, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dx, dcFd2))));

                tv3 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dy, dx)));
                tv3 = mul_intrin(tv3, rinv7);
                tv3 = add_intrin(
                    tv3, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dy, dcFd0))));
                tv4 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dy, dy)));
                tv4 = mul_intrin(tv4, rinv7);
                tv4 = add_intrin(
                    tv4, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dy, dcFd1))));
                tv4 = add_intrin(
                    tv4, mul_intrin(negone, mul_intrin(rinv5, commonCoeff)));
                tv5 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dy, dz)));
                tv5 = mul_intrin(tv5, rinv7);
                tv5 = add_intrin(
                    tv5, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dy, dcFd2))));

                tv6 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dz, dx)));
                tv6 = mul_intrin(tv6, rinv7);
                tv6 = add_intrin(
                    tv6, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dz, dcFd0))));
                tv7 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dz, dy)));
                tv7 = mul_intrin(tv7, rinv7);
                tv7 = add_intrin(
                    tv7, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dz, dcFd1))));
                tv8 = mul_intrin(five,
                                 mul_intrin(commonCoeff, mul_intrin(dz, dz)));
                tv8 = mul_intrin(tv8, rinv7);
                tv8 = add_intrin(
                    tv8, mul_intrin(negone,
                                    mul_intrin(rinv5, mul_intrin(dz, dcFd2))));
                tv8 = add_intrin(
                    tv8, mul_intrin(negone, mul_intrin(rinv5, commonCoeff)));
            ...
            tv0ac = add_intrin(mul_intrin(tv0ac, ooep),
                               load_intrin<Vec_t>(&trg_value[0][t]));
            tv1ac = add_intrin(mul_intrin(tv1ac, ooep),
                               load_intrin<Vec_t>(&trg_value[1][t]));
            tv2ac = add_intrin(mul_intrin(tv2ac, ooep),
                               load_intrin<Vec_t>(&trg_value[2][t]));
            tv3ac = add_intrin(mul_intrin(tv3ac, ooep),
                               load_intrin<Vec_t>(&trg_value[3][t]));
            tv4ac = add_intrin(mul_intrin(tv4ac, ooep),
                               load_intrin<Vec_t>(&trg_value[4][t]));
            tv5ac = add_intrin(mul_intrin(tv5ac, ooep),
                               load_intrin<Vec_t>(&trg_value[5][t]));
            tv6ac = add_intrin(mul_intrin(tv6ac, ooep),
                               load_intrin<Vec_t>(&trg_value[6][t]));
            tv7ac = add_intrin(mul_intrin(tv7ac, ooep),
                               load_intrin<Vec_t>(&trg_value[7][t]));
            tv8ac = add_intrin(mul_intrin(tv8ac, ooep),
                               load_intrin<Vec_t>(&trg_value[8][t]));
