...
void stokes_pvel_uKernel(Matrix<Real_t> &src_coord, Matrix<Real_t> &src_value,
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                vx = add_intrin(
                    vx, mul_intrin(add_intrin(mul_intrin(r2, fx),
                                              mul_intrin(dx, commonCoeff)),
                                   rinv3));
                vy = add_intrin(
                    vy, mul_intrin(add_intrin(mul_intrin(r2, fy),
                                              mul_intrin(dy, commonCoeff)),
                                   rinv3));
                vz = add_intrin(
                    vz, mul_intrin(add_intrin(mul_intrin(r2, fz),
...
void stokes_pvel(T *r_src, int src_cnt, T *v_src, int dof, T *r_trg,
                 int trg_cnt, T *v_trg, mem::MemoryManager *mem_mgr) {
#define STK_KER_NWTN(nwtn)                                                     \
    if (newton_iter == nwtn)                                                   \
    generic_kernel<Real_t, 4, 4,                                               \
                   stokes_pvel_uKernel<Real_t, Vec_t,                          \
...
template <class Real_t, class Vec_t = Real_t,
          Vec_t (*RSQRT_INTRIN)(Vec_t) = rsqrt_intrin0<Vec_t>>
void stokes_pvelgrad_uKernel(Matrix<Real_t> &src_coord,
...
#define SRC_BLK 500
    ...
    const Real_t FACV5 = 1.0 / (8 * nwtn_scal * nwtn_scal * nwtn_scal *
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                Vec_t qxx =
                    add_intrin(r2, mul_intrin(nthree, mul_intrin(dx, dx)));
                Vec_t qxy = mul_intrin(nthree, mul_intrin(dx, dy));
                Vec_t qxz = mul_intrin(nthree, mul_intrin(dx, dz));
                Vec_t qyy =
                    add_intrin(r2, mul_intrin(nthree, mul_intrin(dy, dy)));
                Vec_t qyz = mul_intrin(nthree, mul_intrin(dy, dz));
                Vec_t qzz =
                    add_intrin(r2, mul_intrin(nthree, mul_intrin(dz, dz)));

                // px dp/dx, etc
                commonCoeff = add_intrin(commonCoeff, tr);
                px =
                    add_intrin(mul_intrin(r2, fx),
                               mul_intrin(mul_intrin(nthree, dx), commonCoeff));
                py =
                    add_intrin(mul_intrin(r2, fy),
                               mul_intrin(mul_intrin(nthree, dy), commonCoeff));
                pz =
                    add_intrin(mul_intrin(r2, fz),
                               mul_intrin(mul_intrin(nthree, dz), commonCoeff));

                // vxx = dvx/dx , etc
                commonCoeff = sub_intrin(commonCoeff, tr);
                vxx = mul_intrin(qxx, commonCoeff);
                vxy =
                    add_intrin(mul_intrin(qxy, commonCoeff),
                               mul_intrin(r2, sub_intrin(mul_intrin(dx, fy),
                                                         mul_intrin(dy, fx))));
                vxz =
                    add_intrin(mul_intrin(qxz, commonCoeff),
                               mul_intrin(r2, sub_intrin(mul_intrin(dx, fz),
                                                         mul_intrin(dz, fx))));

                vyx =
                    add_intrin(mul_intrin(qxy, commonCoeff),
                               mul_intrin(r2, sub_intrin(mul_intrin(dy, fx),
                                                         mul_intrin(dx, fy))));
                vyy = mul_intrin(qyy, commonCoeff);
                vyz =
                    add_intrin(mul_intrin(qyz, commonCoeff),
                               mul_intrin(r2, sub_intrin(mul_intrin(dy, fz),
                                                         mul_intrin(dz, fy))));

                vzx =
                    add_intrin(mul_intrin(qxz, commonCoeff),
                               mul_intrin(r2, sub_intrin(mul_intrin(dz, fx),
                                                         mul_intrin(dx, fz))));
                vzy =
                    add_intrin(mul_intrin(qyz, commonCoeff),
                               mul_intrin(r2, sub_intrin(mul_intrin(dz, fy),
                                                         mul_intrin(dy, fz))));
            ...
            pgxSum = add_intrin(mul_intrin(pgxSum, facp5),
                                load_intrin<Vec_t>(&trg_value[4][t]));
            pgySum = add_intrin(mul_intrin(pgySum, facp5),
                                load_intrin<Vec_t>(&trg_value[5][t]));
            pgzSum = add_intrin(mul_intrin(pgzSum, facp5),
                                load_intrin<Vec_t>(&trg_value[6][t]));

            vxgxSum = add_intrin(mul_intrin(vxgxSum, facv5),
                                 load_intrin<Vec_t>(&trg_value[7][t]));
            vxgySum = add_intrin(mul_intrin(vxgySum, facv5),
                                 load_intrin<Vec_t>(&trg_value[8][t]));
            vxgzSum = add_intrin(mul_intrin(vxgzSum, facv5),
                                 load_intrin<Vec_t>(&trg_value[9][t]));

            vygxSum = add_intrin(mul_intrin(vygxSum, facv5),
                                 load_intrin<Vec_t>(&trg_value[10][t]));
            vygySum = add_intrin(mul_intrin(vygySum, facv5),
                                 load_intrin<Vec_t>(&trg_value[11][t]));
            vygzSum = add_intrin(mul_intrin(vygzSum, facv5),
                                 load_intrin<Vec_t>(&trg_value[12][t]));

            vzgxSum = add_intrin(mul_intrin(vzgxSum, facv5),
                                 load_intrin<Vec_t>(&trg_value[13][t]));
            vzgySum = add_intrin(mul_intrin(vzgySum, facv5),
                                 load_intrin<Vec_t>(&trg_value[14][t]));
            vzgzSum = add_intrin(mul_intrin(vzgzSum, facv5),
...
// '##' is the token parsing operator
template <class T, int newton_iter = 0>
void stokes_pvelgrad(T *r_src, int src_cnt, T *v_src, int dof, T *r_trg,
                     int trg_cnt, T *v_trg, mem::MemoryManager *mem_mgr) {
#define STK_KER_NWTN(nwtn)                                                     \
    if (newton_iter == nwtn)                                                   \
    generic_kernel<Real_t, 4, 16,                                              \
                   stokes_pvelgrad_uKernel<                                    \
...
template <class Real_t, class Vec_t = Real_t,
          Vec_t (*RSQRT_INTRIN)(Vec_t) = rsqrt_intrin0<Vec_t>>
void stokes_traction_uKernel(Matrix<Real_t> &src_coord,
                             Matrix<Real_t> &src_value,
                             Matrix<Real_t> &trg_coord,
                             Matrix<Real_t> &trg_value) {
#define SRC_BLK 500
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                commonCoeff = sub_intrin(commonCoeff, tr);
                Vec_t diag =
                    mul_intrin(mul_intrin(mul_intrin(tr, r2), rinv5), invthree);

                tv0 = add_intrin(
                    tv0, mul_intrin(rinv5, mul_intrin(mul_intrin(dx, dx),
                                                      commonCoeff)));
                tv0 = add_intrin(tv0, diag);
                tv1 = add_intrin(
                    tv1, mul_intrin(rinv5, mul_intrin(mul_intrin(dx, dy),
                                                      commonCoeff)));
                tv2 = add_intrin(
                    tv2, mul_intrin(rinv5, mul_intrin(mul_intrin(dx, dz),
                                                      commonCoeff)));
                tv3 = add_intrin(
                    tv3, mul_intrin(rinv5, mul_intrin(mul_intrin(dy, dx),
                                                      commonCoeff)));
                tv4 = add_intrin(
                    tv4, mul_intrin(rinv5, mul_intrin(mul_intrin(dy, dy),
                                                      commonCoeff)));
                tv4 = add_intrin(tv4, diag);
                tv5 = add_intrin(
                    tv5, mul_intrin(rinv5, mul_intrin(mul_intrin(dy, dz),
                                                      commonCoeff)));
                tv6 = add_intrin(
                    tv6, mul_intrin(rinv5, mul_intrin(mul_intrin(dz, dx),
                                                      commonCoeff)));
                tv7 = add_intrin(
                    tv7, mul_intrin(rinv5, mul_intrin(mul_intrin(dz, dy),
                                                      commonCoeff)));
                tv8 = add_intrin(
                    tv8, mul_intrin(rinv5, mul_intrin(mul_intrin(dz, dz),
                                                      commonCoeff)));
                tv8 = add_intrin(tv8, diag);
            }
            Vec_t ooep = set_intrin<Vec_t, Real_t>(OOEP);

            tv0 = add_intrin(mul_intrin(tv0, ooep),
                             load_intrin<Vec_t>(&trg_value[0][t]));
            tv1 = add_intrin(mul_intrin(tv1, ooep),
                             load_intrin<Vec_t>(&trg_value[1][t]));
            tv2 = add_intrin(mul_intrin(tv2, ooep),
                             load_intrin<Vec_t>(&trg_value[2][t]));
            tv3 = add_intrin(mul_intrin(tv3, ooep),
                             load_intrin<Vec_t>(&trg_value[3][t]));
            tv4 = add_intrin(mul_intrin(tv4, ooep),
                             load_intrin<Vec_t>(&trg_value[4][t]));
            tv5 = add_intrin(mul_intrin(tv5, ooep),
                             load_intrin<Vec_t>(&trg_value[5][t]));
            tv6 = add_intrin(mul_intrin(tv6, ooep),
                             load_intrin<Vec_t>(&trg_value[6][t]));
            tv7 = add_intrin(mul_intrin(tv7, ooep),
                             load_intrin<Vec_t>(&trg_value[7][t]));
            tv8 = add_intrin(mul_intrin(tv8, ooep),
                             load_intrin<Vec_t>(&trg_value[8][t]));
...
template <class T, int newton_iter = 0>
void stokes_traction(T *r_src, int src_cnt, T *v_src, int dof, T *r_trg,
                     int trg_cnt, T *v_trg, mem::MemoryManager *mem_mgr) {
#define STK_KER_NWTN(nwtn)                                                     \
    if (newton_iter == nwtn)                                                   \
    generic_kernel<Real_t, 4, 9,                                               \
                   stokes_traction_uKernel<                                    \
                       Real_t, Vec_t, rsqrt_intrin##nwtn<Vec_t, Real_t>>>(     \
        (Real_t *)r_src, src_cnt, (Real_t *)v_src, dof, (Real_t *)r_trg,       \
        trg_cnt, (Real_t *)v_trg, mem_mgr)
#define STOKES_KERNEL                                                          \
...
template <class Real_t, class Vec_t = Real_t,
          Vec_t (*RSQRT_INTRIN)(Vec_t) = rsqrt_intrin0<Vec_t>>
void stokes_pvellaplacian_uKernel(Matrix<Real_t> &src_coord,
                                  Matrix<Real_t> &src_value,
                                  Matrix<Real_t> &trg_coord,
                                  Matrix<Real_t> &trg_value) {
#define SRC_BLK 500
    ...
    const Real_t FACV =
        1.0 / (8 * nwtn_scal * nwtn_scal * nwtn_scal * const_pi<Real_t>());
    const Real_t FACLAP = 1.0 / (4 * nwtn_scal * nwtn_scal * nwtn_scal *
                                 nwtn_scal * nwtn_scal * const_pi<Real_t>());
    const Vec_t facv = set_intrin<Vec_t, Real_t>(FACV);
    const Vec_t facp = set_intrin<Vec_t, Real_t>(2 * FACV);
    const Vec_t faclap = set_intrin<Vec_t, Real_t>(
        FACLAP); // laplacian = 1/(4pi) (I/r^3-3rr/r^5)
    const Vec_t nthree = set_intrin<Vec_t, Real_t>(-3.0);
    ...
    for (size_t sblk = 0; sblk < src_cnt_; sblk += SRC_BLK) {
        ...
        for (size_t t = 0; t < trg_cnt_; t += VecLen) {
            ...
            for (size_t s = sblk; s < sblk + src_cnt; s++) {
                ...
                commonCoeff = add_intrin(commonCoeff, tr);
                vxlap =
                    add_intrin(vxlap, mul_intrin(mul_intrin(fx, r2), rinv5));
                vxlap = add_intrin(
                    vxlap,
                    mul_intrin(
                        mul_intrin(mul_intrin(commonCoeff, nthree), rinv5),
                        dx));
                vylap =
                    add_intrin(vylap, mul_intrin(mul_intrin(fy, r2), rinv5));
                vylap = add_intrin(
                    vylap,
                    mul_intrin(
                        mul_intrin(mul_intrin(commonCoeff, nthree), rinv5),
                        dy));
                vzlap =
                    add_intrin(vzlap, mul_intrin(mul_intrin(fz, r2), rinv5));
                vzlap = add_intrin(
                    vzlap,
                    mul_intrin(
                        mul_intrin(mul_intrin(commonCoeff, nthree), rinv5),
            ...
            vz = add_intrin(mul_intrin(vz, facv),
                            load_intrin<Vec_t>(&trg_value[3][t]));
            vxlap = add_intrin(mul_intrin(vxlap, faclap),
                               load_intrin<Vec_t>(&trg_value[4][t]));
            vylap = add_intrin(mul_intrin(vylap, faclap),
                               load_intrin<Vec_t>(&trg_value[5][t]));
            vzlap = add_intrin(mul_intrin(vzlap, faclap),
                               load_intrin<Vec_t>(&trg_value[6][t]));
...
// '##' is the token parsing operator
template <class T, int newton_iter = 0>
void stokes_pvellaplacian(T *r_src, int src_cnt, T *v_src, int dof, T *r_trg,
                          int trg_cnt, T *v_trg, mem::MemoryManager *mem_mgr) {
#define STK_KER_NWTN(nwtn)                                                     \
    if (newton_iter == nwtn)                                                   \
    generic_kernel<Real_t, 4, 7,                                               \
                   stokes_pvellaplacian_uKernel<                               \
                       Real_t, Vec_t, rsqrt_intrin##nwtn<Vec_t, Real_t>>>(     \
        (Real_t *)r_src, src_cnt, (Real_t *)v_src, dof, (Real_t *)r_trg,       \
        trg_cnt, (Real_t *)v_trg, mem_mgr)
#define STOKES_KERNEL                                                          \
...
inline const Kernel<T> &StokesSingleLayerKernel<T>::PVel() {
    static Kernel<T> s2t_ker = BuildKernel<T, stokes_pvel<T, NEWTON_ITE>>(
...
inline const Kernel<T> &StokesSingleLayerKernel<T>::PVelGrad() {
    static Kernel<T> stk_ker = BuildKernel<T, stokes_pvel<T, NEWTON_ITE>>(
        "stokes_pvel", 3, std::pair<int, int>(3, 4));
    static Kernel<T> s2t_ker = BuildKernel<T, stokes_pvelgrad<T, NEWTON_ITE>>(
        "stokes_pvelgrad", 3, std::pair<int, int>(3, 16), &stk_ker, &stk_ker,
        NULL, &stk_ker, &stk_ker, NULL, &stk_ker, NULL);
    return s2t_ker;
}
...
inline const Kernel<T> &StokesSingleLayerKernel<T>::Traction() {
    static Kernel<T> stk_ker = BuildKernel<T, stokes_pvel<T, NEWTON_ITE>>(
        "stokes_pvel", 3, std::pair<int, int>(3, 4));
    static Kernel<T> s2t_ker = BuildKernel<T, stokes_traction<T, NEWTON_ITE>>(
        "stokes_traction", 3, std::pair<int, int>(3, 9), &stk_ker, &stk_ker,
        NULL, &stk_ker, &stk_ker, NULL, &stk_ker, NULL);
    return s2t_ker;
}
...
inline const Kernel<T> &StokesSingleLayerKernel<T>::PVelLaplacian() {
    ...
    static Kernel<T> s2t_ker =
        BuildKernel<T, stokes_pvellaplacian<T, NEWTON_ITE>>(
            "stokes_pvellaplacian", 3, std::pair<int, int>(3, 7), &stk_ker,
